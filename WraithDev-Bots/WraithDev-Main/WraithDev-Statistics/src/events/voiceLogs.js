...
moment.locale("tr")
const {  wraithsdevRevu, wraithsdevOk, wraithsdevTik, wraithsdevRed } = require("../../../src/configs/emojis.json")
...
.setDescription(`
${wraithsdevTik} ${newState.member} isimli kullanıcı bir sesli kanalına girdi.
...
.setDescription(`
${wraithsdevRed} ${oldState.member} isimli kullanıcı bir sesli kanalından ayrıldı.
...
channel.wsend({ embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(allah.GuildID).name, iconURL: client.guilds.cache.get(allah.GuildID).iconURL({dynamic:true})}).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 })) 
.setDescription(`
${wraithsdevTik} ${newState.member} isimli kullanıcı bir sesli kanal değişimi yaptı.
...
.setDescription(`
${wraithsdevRed} ${newState.member} isimli kullanıcı bir sesli kanalda kendi susturmasını kaldırdı.
...
channel2.wsend({ embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(allah.GuildID).name, iconURL: client.guilds.cache.get(allah.GuildID).iconURL({dynamic:true})}).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 })) 
.setDescription(`
${wraithsdevTik} ${newState.member} isimli kullanıcı bir sesli kanalda kendini susturdu.
...
channel2.wsend({ embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(allah.GuildID).name, iconURL: client.guilds.cache.get(allah.GuildID).iconURL({dynamic:true})}).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 })) 
.setDescription(`
${wraithsdevRed} ${newState.member} isimli kullanıcı bir sesli kanalda kendi sağırlaştırmasını kaldırdı.
...
channel2.wsend({ embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(allah.GuildID).name, iconURL: client.guilds.cache.get(allah.GuildID).iconURL({dynamic:true})}).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 })) 
.setDescription(`
${wraithsdevTik} ${newState.member} isimli kullanıcı bir sesli kanalda kendini sağırlaştırdı.
