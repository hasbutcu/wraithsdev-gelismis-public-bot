...
module.exports = {
  conf: {
    aliases: ["uyarı","warn"],
    name: "uyarı",
    help: "uyarı <wraithsdev/ID> <Sebep>",
  ...
  run: async (client, message, args, embed) => {
    ...
    message.reply({ content: `${wraithsdevTik} ${member.toString()} üyesi, ${message.author} tarafından, \`${reason}\` nedeniyle uyarıldı! Devamında mute veya daha ağır bir ceza alacaksınız. \`(Ceza ID: #${penal.id})\``}).then((e) => setTimeout(() => { e.delete(); }, 50000));
