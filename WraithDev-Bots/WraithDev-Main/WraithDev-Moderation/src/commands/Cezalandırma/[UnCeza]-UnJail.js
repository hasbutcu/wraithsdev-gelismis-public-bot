...
const { wraithsdevRed, wraithsdevTik, wraithsdevRevu} = require("../../../../src/configs/emojis.json")
const ayar = require("../../../../src/configs/ayarName.json");
module.exports = {
  conf: {
    aliases: ["unjail"],
    name: "unjail",
    help: "unjail <wraithsdev/ID>",
  ...
  run: async (client, message,  args, embed) => {
    ...
    message.reply({ content:`${wraithsdevTik} ${member.toString()} üyesinin jaili ${message.author} tarafından kaldırıldı!`}).then((e) => setTimeout(() => { e.delete(); }, 50000));
