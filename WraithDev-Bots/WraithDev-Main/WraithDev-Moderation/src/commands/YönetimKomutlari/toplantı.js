...
const { wraithsdevStar, wraithsdevRed, wraithsdevTik } = require("../../../../src/configs/emojis.json");
...
embed.addFields({ name: `${wraithsdevStar} Son Toplantı Bilgisi`, value: `
> Toplantıya **\`${MeetingData.Joining.length}\`** yetkili katılmış ${wraithsdevTik}
> Toplantıya **\`${MeetingData.Leaving.length}\`** yetkili katılmamış ${wraithsdevRed}
...
**${guild.name}** sunucusunda şuan da toplantı durumu: **${meetingStatus ? "Aktif" : "Devre-dışı"}** ${meetingStatus ? wraithsdevTik : wraithsdevRed}`)
...
${wraithsdevStar} **Bitirilen Toplantı Bilgisi**
> Bu toplantıda katılması beklenen **(\`${KatilimData.Leaving.length + KatilimData.Joining.length} yetkili\`)**
> Bu toplantıda katılım sağlayan: **(\`${KatilimData.Joining.length} yetkili\`)** ${wraithsdevTik}
> Bu toplantıda katılım sağlamayan: **(\`${KatilimData.Leaving.length} yetkili\`)** ${wraithsdevRed}
