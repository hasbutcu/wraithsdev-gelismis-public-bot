...
const {  wraithsdevOk, wraithsdevStar, wraithsdevSonsuz } = require("../../../../src/configs/emojis.json");
...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(`
${wraithsdevStar} Toplam **${total}** davet. \`(${regular} gerçek, ${bonus} bonus, ${leave} ayrılmış, ${fake} fake)\`
