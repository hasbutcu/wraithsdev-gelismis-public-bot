...
const { miniicon ,wraithsdevStar , wraithsdevd2, wraithsdevb2, wraithsdevd1, wraithsdevb3, wraithsdevd3, red } = require("../../../../src/configs/emojis.json");
...
embed.addFields({ name: `${wraithsdevStar} **Sesli Sohbet İstatistiği**`, value: `
...
`, inline: false },
{ name:`${wraithsdevStar} **Mesaj İstatistiği**`,value: `
...
.addFields({ name:`${wraithsdevStar} **Puan Detayları:**`, value:`
...
`, inline: false },
{ name:`${wraithsdevStar} **Net Puanlama Bilgisi**`, value:`
...
`, inline: false },
{ name:`${wraithsdevStar} **Puan Durumu:**`, value:`
...
`, inline: false },
{ name:`${wraithsdevStar} **Yetki Durumu:**`, value:`
${coinStatus}
`, inline: false })
...
`) 
.addFields({ name:`${wraithsdevStar} **Ceza Kullanımı**`, value: `\`\`\`fix
...
`, inline: false },
{ name:`${wraithsdevStar} **Ceza Puan Detayları:**`, value: `
...
.addFields({ name:`${wraithsdevStar} **Sesli Sohbet İstatistiği**`, value:`
${miniicon} Toplam: \`${moment.duration(voiceData ? voiceData.topStat : 0).format("H [saat], m [dakika]")}\`
${miniicon} Public Odalar: \`${await category(conf.publicParents)}\`
${miniicon} Secret Odalar: \`${await category(conf.privateParents)}\`
${miniicon} Alone Odalar: \`${await category(conf.aloneParents)}\`
