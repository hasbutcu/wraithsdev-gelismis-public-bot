...
module.exports = {
  ...
  async execute(interaction, client) {
	...
	{name: `❯ Sunucu Bilgisi`,value:`
	  ...
	  `});
		if (client.guilds.cache.get(allah.GuildID).members.cache.get(interaction.targetId).permissions.has(PermissionsBitField.Flags.Administrator) || Ayarlar.teyitciRolleri.some(x => client.guilds.cache.get(allah.GuildID).members.cache.get(interaction.targetId).roles.cache.has(x))) 
