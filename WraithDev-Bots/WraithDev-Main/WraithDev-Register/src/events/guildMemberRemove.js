...
module.exports = async (member) => {
  ...
  if (!inviteMemberData) {
    channel.wsend({ content: `${wraithsdevRed} \`${member.user.tag}\` sunucumuzdan ayrıldı ama kim tarafından davet edildiğini bulamadım. Sunucumuzda **${member.guild.memberCount}** Üye Kaldi `});
  } else {
    ...
    channel.wsend({ content:`${wraithsdevRed} \`${member.user.tag}\` sunucumuzdan ayrıldı. ${inviter.tag} tarafından davet edilmişti. (**${total}** daveti) Sunucumuzda **${member.guild.memberCount}** Üye Kaldi `});
